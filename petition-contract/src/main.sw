...
use std::{auth::msg_sender, block::height, context::msg_amount, hash::Hash,};
use ::interface::{Info, Petition};
...
impl Petition for Contract {
    ...
    fn sign_petition(campaign_id: u64) {
        ...
        storage
            .sign_history
            .insert((user, sign_count + 1), Signs::new(campaign_id));
        ...
        storage
            .sign_history_index
            .insert((user, campaign_id), sign_count + 1);
    ...
    fn unsign_petition(campaign_id: u64) {
        ...
        storage
            .sign_history
            .insert((user, sign_history_index), signed);
